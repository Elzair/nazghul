...
(define jim-conv
  (ifc basic-conv
       ...
       (method 'join (lambda (knpc kpc) (say knpc "Here I make my stand, come what may.")))

       (method 'trig (lambda (knpc kpc) (say knpc "Trigrave is the crossroads of the "
