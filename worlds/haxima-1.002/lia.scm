...
(define (lia-trade knpc kpc)  
  (if (not (string=? "working" (kern-obj-get-activity knpc)))
      ...
      (kern-conv-trade knpc kpc
                       ...
                       (list nightshade              60)
                       (list mandrake                50)
                       (list in_ex_por_scroll        (* 2 50))
                       (list in_an_scroll            (* 3 50))
                       (list an_tym_scroll           (* 4 50))
                       (list in_mani_cor_scroll      (* 4 50))
                       (list vas_rel_por_scroll      (* 2 50))
                       (list vas_mani_scroll         (* 2 50))
                       (list wis_quas_scroll         (* 2 50))
                       )))
