        ...
        (kern-mk-char
          ...
          (kern-mk-container
            ...
            (list
              ...
              (list 4 t_gold_coins)
              (list 4 t_leather_helm)
              (list 4 t_mace)
              (list 4 t_dagger)
              (list 4 t_armor_leather)
            )
          )
          (list
            t_leather_helm
      ...
      (kern-mk-place 'p_mushroom_cave "Mushroom Cave"
        ...
        (kern-mk-map
          ...
          (list
            ...
            "rr .. .. .. && rr rr .. rr rr .. .. .. tt || rr "
            "rr .. .. .. .. .. rr rr rr {{ .. .. tt || rr rr "
            "rr rr tt .. .. rr rr rr rr rr tt tt || rr rr rr "
            "rr rr rr rr rr rr rr rr rr rr rr rr rr rr rr rr "
          )
        )
        #f #t #f #f
