...
(mk-spell 'vas_uus_ylem     "Raise Ship <Vas Uus Ylem>"         vas-uus-ylem     "VUY"  6 context-wilderness s_vas_uus_ylem (list mandrake blood_moss spider_silk))
...
(mk-spell 'vas_por          "Teleport Party <Vas Por>"          vas-por          "VP"   6 context-wilderness s_vas_por      (list mandrake black_pearl blood_moss))
...
;; Eighth Circle
(mk-spell 'kal_xen_nox      "Summon Sline <Kal Xen Nox>"        kal-xen-nox      "KXN"  8 context-town s_kal_xen_nox      (list spider_silk mandrake nightshade))
