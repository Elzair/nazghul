  (kern-mk-composite-map
    ...
    (kern-mk-map nil 32 32 pal_expanded
      (list
        ...
        ".. .. .. .. {{ {{ ^^ ^^ ^^ ^^ ^^ {{ .. .. .. tt ~~ ~~ tt tt tt tt -- -- __ __ __ __ __ __ __ __ "
        ".. .. .. .. .. {{ {{ ^^ ^^ ^^ {{ {{ .. .. .. tt ~~ tt tt .. .. tt tt -- __ __ __ __ __ __ -- -- "
      )
    )
    (kern-mk-map nil 32 32 pal_expanded
      (list
    ...
    (kern-mk-map nil 32 32 pal_expanded
      (list
        "tt tt ~~ {{ {{ ^^ {{ {{ {{ ~~ {{ {{ {{ ^^ ^^ {{ tt tt tt .. /8 /d /d /d /d /d /d /d /d /1 /d /d "
        "tt tt ~~ {{ ^^ ^^ ^^ ^^ {{ ~~ ~~ {{ ^^ ^^ ^^ {{ {{ {{ {{ .. .. .. .. .. tt || || || || /b || || "
        "tt tt ~~ {{ ^^ ^^ ^^ ^^ {{ {{ {{ {{ ^^ ^^ ^^ ^^ {{ {{ {{ {{ {{ {{ tt tt tt || || || tt tt || || "
        "tt tt ~~ {{ {{ ^^ ^^ ^^ ^^ ^^ {{ ^^ ^^ ^^ ^^ ^^ ^^ ^^ ^^ ^^ ^^ {{ {{ {{ tt tt || || tt tt tt || "
        "tt tt ~~ ~~ {{ {{ {{ {{ ^^ ^^ ^^ ^^ ^^ ^^ ^^ ^^ ^^ ^^ ^^ ^^ ^^ ^^ ^^ {{ {{ tt || || tt tt tt || "
    ...
    (kern-mk-map nil 32 32 pal_expanded
      (list
        "/d /2 || || || || || || tt tt tt || tt || || tt tt tt tt || || || || || || || || || || || tt tt "
        "|| /7 || || || || || tt tt || tt tt tt tt || || tt || || || || || || || || || || || || || || tt "
        "|| /8 /d /e .. tt tt .. || || || || tt tt tt tt tt || || || || || || || || || || || || || || tt "
        "|| || || || || || || || || || || || || tt tt tt || || || || || || || || || || || || || || tt tt "
        "|| || || || || || || || || || || || || tt tt tt || || || || || || || || || || || || || tt tt tt "
