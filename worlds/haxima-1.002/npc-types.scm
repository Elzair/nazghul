...
;;      ======================          ========================== ================ ========== ================== ============ ====================== ============= ==============   ========
(define forest-goblin-shaman  (mk-npct2 "a forest goblin shaman"  sp_forest_goblin oc_wizard  s_orc  wizard-traps wizard-equip  nil 'shaman-ai  faction-forest-goblin nil 'drop-generic wizard-loot ))
(define forest-goblin-hunter  (mk-npct2 "a forest goblin hunter"  sp_forest_goblin oc_warrior s_orc  basic-traps  archer-equip  nil 'generic-ai faction-forest-goblin nil 'drop-generic archer-loot ))
(define forest-goblin-stalker (mk-npct2 "a forest goblin stalker" sp_forest_goblin oc_warrior s_orc  basic-traps  stalker-equip nil 'generic-ai faction-forest-goblin nil 'drop-generic stalker-loot))

(define cave-goblin-slinger   (mk-npct2 "a cave goblin slinger"   sp_cave_goblin  oc_warrior s_orc    basic-traps  slinger-equip    nil 'generic-ai faction-cave-goblin  nil 'drop-generic slinger-loot))
(define cave-goblin-berserker (mk-npct2 "a cave goblin berserker" sp_cave_goblin  oc_warrior s_orc    basic-traps  berserker-equip  nil 'generic-ai faction-cave-goblin  nil 'drop-generic berserker-loot))
(define cave-goblin-priest    (mk-npct2 "a cave goblin priest"    sp_cave_goblin  oc_wizard  s_orc    wizard-traps wizard-equip     nil 'priest-ai  faction-cave-goblin  nil 'drop-generic wizard-loot))
...
(define craven-archer (mk-npct2 "a craven archer" sp_skeleton oc_warrior s_knight   basic-traps craven-archer-equip nil            'craven-archer-ai faction-monster nil 'drop-generic cra-arch-loot))

(define halberdier    (mk-npct2 "a halberdier"    sp_human    oc_warrior s_guard        no-traps halberdier-equip   nil 'guard-ai faction-men   nil 'drop-generic halberdier-loot))
(define crossbowman   (mk-npct2 "a crossbowman"   sp_human    oc_warrior s_guard        no-traps crossbowman-equip  nil 'guard-ai faction-men   nil 'drop-generic crossbowman-loot))
(define medik         (mk-npct2 "a medik"         sp_human    oc_wizard  s_blue_wizard  no-traps medik-equip        nil 'medik-ai faction-men   nil 'drop-generic medik-loot))
...
(define bomber (mk-npct2 "a mad jester" sp_human oc_wrogue s_jester wrogue-traps bomber-equip nil 'std-ai faction-outlaw nil 'drop-generic bomber-loot))
(define knight (mk-npct2 "a knight" sp_human oc_warrior s_knight no-traps knight-equip nil 'guard-ai faction-trigrave 'knight-conv 'drop-generic knight-loot))
