...
(define troll                  (mk-npct "a troll"                  sp_troll         oc_warrior s_troll            no-traps     troll-equip            nil           'std-ai          faction-troll        ))
(define troll-geomancer        (mk-npct "a troll geomancer"        sp_troll         oc_wizard  s_troll            no-traps     geomancer-equip        nil           'std-ai          faction-troll        ))
