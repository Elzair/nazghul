...
(define nixie-spearman  (mk-npct "nixie spearman"         sp_nixie         oc_warrior s_nixie        no-traps     nixie-1-equip nil           'nixie-ai        faction-monster       nil))
(define nixie-swordsman (mk-npct "nixie swordsman"        sp_nixie         oc_warrior s_nixie        no-traps     nixie-2-equip nil           'nixie-ai        faction-monster       nil))
