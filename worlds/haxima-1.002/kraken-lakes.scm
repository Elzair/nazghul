 ...
 (kern-mk-map 
  nil 38 38 pal_expanded 
	(list
		...
		"rr rr _3 _1 _1 _5 {{ {{ {{ {{ {{ {{ {{ {{ rr {{ rr rr rr bb %3 %% %% ~6 %% %% %5 .. .. .. .. .. %3 %% %% %% %5 rr "
		"rr _3 __ __ __ __ =| _1 _1 _5 rr rr rr {{ {{ {{ {{ {{ {{ {% %e bb %a ~6 %% %% %% bb .. .. .. bb %% %% %% %% %% rr "
		...
		"rr {{ {{ {{ rr {{ {L __ __ __ __ ~8 ~8 ~8 ~~ ~~ ~~ ~~ ~~ bb ~9 ~~ ~~ ~5 .. .. == .. .. .. .. .. .. .. %e bb %% rr "
		"rr {{ rr {{ {{ {L _3 __ __ _c {G {{ {{ {{ {H -a ~~ ~~ ~~ ~~ %% bb ~~ bb %7 bb ~4 %5 .. .. .. %3 %5 .. .. %b %% rr "
		"rr {{ {L _3 _1 __ __ __ __ {G {{ rr rr rr {{ {H ~~ ~~ ~~ ~~ ~~ ~~ ~~ %% %% %% ~6 %% %5 .. ~3 ~9 ~9 ~d .. bb %% rr "
		"rr {{ _3 __ __ __ __ __ _4 {{ rr rr {{ rr rr {{ ~2 ~~ ~~ ~~ ~~ ~~ ~8 ~9 ~1 ~9 ~c %% %% %% ~6 %% %% .. .. %b %% rr "
		"rr {{ _a __ __ __ __ __ _4 {{ rr {{ {{ {{ rr {{ ~2 ~~ -- ~~ ~~ bb %% %% ~6 %% %% %% %% bb ~~ bb %% .. %7 bb %% rr "
		"rr {{ {H _a __ __ __ __ _c {{ rr {{ {{ {{ rr {{ ~2 -- __ -- ~~ ~~ ~5 %% ~6 %c bb ~1 ~1 ~8 ~8 ~8 ~9 =| ~9 ~9 ~9 ~~ "
		"rr {{ {{ {H _a _8 _8 _c {G {{ rr rr {{ rr rr {{ ~2 __ __ __ ~~ ~~ ~~ bb ~~ bb %3 ~~ bb bb %% %% %% .. .. bb %e rr "
		"rr rr {{ {{ {{ {{ {{ {{ bb {{ {{ rr {{ {{ {{ {L ~~ -- __ -- ~~ ~~ ~~ ~~ -- ~~ ~~ ~~ ~~ ~4 %% %% %% %5 .. .. .. rr "
		"rr rr rr rr rr {1 rr {{ {{ {{ rr rr bb ~3 ~1 ~~ ~~ ~~ -- ~~ ~~ ~~ ~~ ~~ __ __ ~~ bb %% ~~ ~9 bb ~9 ~d .. bb .. rr "
		"rr rr rr rr rr .. rr rr rr rr rr bb ~3 ~~ bb ~~ ~~ ~8 ~8 ~8 ~8 ~8 ~~ ~~ __ __ ~~ ~~ ~~ %% %% %% %c .. .. .. .. rr "
		"rr rr rr rr {{ {2 .. rr rr rr bb ~3 ~~ bb ~~ ~c {G {{ {{ {{ {{ {{ {H ~a ~~ ~~ ~~ ~~ ~~ ~9 bb .. .. .. bb %7 .. rr "
		"rr rr rr rr {{ {2 .. rr rr rr bb ~~ ~~ ~~ ~c {G {{ rr rr rr rr rr bb bb {H ~a ~~ -- ~~ %c .. .. .. .. %3 %% %5 rr "
		"rr rr {{ bb {1 .. .. bb rr bb ~3 ~~ ~~ ~~ {G {{ {{ rr .. .. .. rr .. .. bb {H ~~ -- ~4 bb .. .. .. bb %% ~7 %% rr "
		"rr {{ {{ {2 .. .. .. .. ~C ~3 ~~ -- -- ~4 {A {{ rr rr .. .. .. rr .. .. .. bb ~2 -- ~4 %d .. .. .. %b ~b ~~ ~9 rr "
		"rr {{ bb .. .. .. bb ~C ~3 ~~ -- -- -- ~4 bb {{ rr && .. .. .. .. .. .. .. bb ~2 -- ~4 bb .. .. .. bb %% ~e %% rr "
		"rr {{ {2 .. .. .. .. ~b ~~ -- -- __ -- ~4 {# {{ rr rr .. .. .. rr .. .. .. bb ~2 -- ~4 %5 .. .. .. .. %a %% %c rr "
		"rr {{ bb .. .. .. bb ~% ~~ -- __ __ __ ~~ {J {{ {{ rr .. .. .. rr .. .. bb {L ~~ -- ~~ %% bb .. .. .. bb %e .. rr "
		"rr rr {{ {2 .. .. .. .. ~a -- -- __ -- -- ~5 {A {{ rr rr .. rr rr bb bb {L ~3 ~~ -- ~~ ~d .. .. .. .. .. .. .. rr "
		"rr rr rr bb .. .. .. bb {H ~~ -- __ __ -- ~~ bb {A {{ {{ {6 {{ {{ {{ {L ~3 ~~ -- -- ~~ bb .. bb .. .. .. bb .. rr "
		"rr rr rr {{ {2 .. {4 {{ rr ~a -- -- __ -- -- ~~ ~1 ~1 ~1 ~1 ~5 {N ~3 ~~ ~~ -- -- -- ~~ bb rr rr .. .. .. .. rr rr "
		"rr rr rr bb .. .. .. bb rr rr ~~ -- __ __ -- -- ~~ -- -- -- ~~ ~~ ~~ -- -- -- ~~ ~~ ~~ ~5 bb rr rr rr .. .. rr rr "
		"rr rr rr {{ {2 .. {4 {{ rr ~b ~~ -- __ __ __ -- -- __ __ __ -- -- -- -- -- ~~ ~c bb ~a ~~ ~~ ~1 ~5 rr .. .. rr rr "
		"rr rr {{ bb .. .. .. bb {{ {H ~~ -- -- -- __ __ __ __ __ __ __ -- -- ~~ ~~ ~c bb bb bb ~~ ~~ bb ~~ rr .. .. .. rr "
		"rr rr {{ {2 .. .. {4 {{ {{ {{ ~a ~8 ~8 ~~ -- -- -- __ __ __ -- -- ~~ ~c bb rr rr rr rr xx xx ~~ ~~ xx xx .. .. rr "
